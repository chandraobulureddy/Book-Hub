...
class BookShelves extends Component {
  ...
  renderBooksProgressView = () => (
    <div className="loader-container loader-shelve" testid="loader">
  ...
  render() {
    ...
    return (
      <div className="book-shelves-container-one">
        <div>
          <Header shelves />
          <div className="book-shelves-sub-div">
              ...
              <div className="book-shelves-filter-container">
                ...
                <ul className="filter-un-order-list-container">
                  {bookshelvesList.map(eachItem => {
                    ...
                    return (
                      <li key={eachItem.label} className="list-style">
                        <button
